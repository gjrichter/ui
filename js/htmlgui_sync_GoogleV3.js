...
(function( ixmaps, $, undefined ) {
	...
	function createMyMap() {
		...
		var mapLargeOptions = {
			mapTypeControlOptions: {
				mapTypeIds: [google.maps.MapTypeId.ROADMAP,google.maps.MapTypeId.SATELLITE,google.maps.MapTypeId.HYBRID,google.maps.MapTypeId.TERRAIN, MY_MAPTYPE_BW_ID, MY_MAPTYPE_WHITE_ID, MY_MAPTYPE_GRAY_ID, MY_MAPTYPE_PALE_ID, MY_MAPTYPE_DARK_ID]
				},
			mapTypeId: google.maps.MapTypeId.ROADMAP		
			,
			panControl: true,
		...
		map.mapTypes.set(MY_MAPTYPE_WHITE_ID, new google.maps.StyledMapType(grayII_stylez,{name: "White" }));
	...
	htmlgui_pinGoogleControls = function(flag){
		var gmapDiv = ixmaps.gmapDiv;
		if ( flag == true ){
			try {
